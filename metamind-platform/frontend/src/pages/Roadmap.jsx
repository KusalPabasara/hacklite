...
function Roadmap() {
    ...
    useEffect(() => {
        const fetchRoadmap = async () => {
            try {
                ...
                let res;
                if (careerId) {
                    res = await api.get(`/roadmap/career/${careerId}`);
                } else {
        ...
        return (
            <div className={`p-6 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
                <div className="text-center">
                    ...
                    <p className={`${isDarkMode ? 'text-emerald-300' : 'text-emerald-600'} text-lg`}>Loading your roadmap...</p>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className={`p-6 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
                <div className="max-w-md mx-auto text-center">
                    <div className={`${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-3xl p-10 shadow-2xl border`}>
                        ...
                        <h3 className={`text-2xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-4`}>Oops! Something went wrong</h3>
                        <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-8`}>{error || "No roadmap available. Please set a career goal first."}</p>
                        <button
    ...
    return (
        <div className={`p-6 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
                ...
                {/* Hero Section */}
                <div className={`relative overflow-hidden ${isDarkMode ? 'bg-gradient-to-br from-emerald-900 via-gray-900 to-teal-900 cyber-grid' : 'bg-gradient-to-br from-emerald-50 via-gray-50 to-teal-50 cyber-grid-light'} py-20`}>
                    ...
                    <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        <h1 className={`text-6xl md:text-7xl font-black ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-6`}>
                            Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-400">Learning Path</span>
                        </h1>
                        <p className={`text-2xl ${isDarkMode ? 'text-emerald-200' : 'text-emerald-700'} max-w-3xl mx-auto`}>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className={`${isDarkMode ? 'glass-effect' : 'glass-effect-light'} rounded-3xl p-10 mb-12 relative overflow-hidden`}>
                        ...
                        <div className="relative z-10">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
                                <div className="text-center">
                                    ...
                                    <h3 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-2`}>Career Goal</h3>
                                    <p className={`${isDarkMode ? 'text-emerald-300' : 'text-emerald-600'} text-lg`}>{data.career || 'Not Set'}</p>
                                </div>
                                <div className="text-center">
                                    ...
                                    <h3 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-2`}>Progress</h3>
                                    <p className={`${isDarkMode ? 'text-cyan-300' : 'text-cyan-600'} text-lg`}>{data.currentStep || 0} / {data.steps?.length || 0} steps</p>
                                </div>
                                <div className="text-center">
                                    ...
                                    <h3 className={`text-xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-2`}>Status</h3>
                                    <p className={`${isDarkMode ? 'text-purple-300' : 'text-purple-600'} text-lg`}>{data.completed ? 'Completed! 🎉' : 'In Progress'}</p>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                <div className={`flex items-center justify-between text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mb-4`}>
                                    ...
                                    <span className={`font-black text-2xl ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{Math.round(progressPercentage)}%</span>
                                </div>
                                <div className={`w-full ${isDarkMode ? 'bg-gray-800' : 'bg-gray-200'} rounded-full h-6 overflow-hidden`}>
                                    <div 
                    ...
                    {data.steps && data.steps.length > 0 && (
                        <div className={`${isDarkMode ? 'glass-effect' : 'glass-effect-light'} rounded-3xl p-10 mb-12`}>
                            <h2 className={`text-3xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-10 text-center`}>Your Learning Journey</h2>
                            
                            <div className="relative">
                                {/* Timeline Line */}
                                <div className={`absolute left-10 top-0 bottom-0 w-1 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-300'}`}></div>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className={`ml-8 flex-1 p-8 rounded-3xl transition-all duration-300 ${
                                                    isCompleted
                                                        ? `${isDarkMode ? 'glass-effect' : 'glass-effect-light'} border-2 border-emerald-500/30`
                                                        : isCurrent
                                                        ? `${isDarkMode ? 'glass-effect' : 'glass-effect-light'} border-2 border-cyan-500/50 neon-green`
                                                        : `${isDarkMode ? 'glass-effect' : 'glass-effect-light'}`
                                                }`}>
                                                    <div className="flex items-center justify-between mb-4">
                                                        <h3 className={`text-2xl font-bold ${
                                                            isCompleted
                                                                ? `${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'} line-through`
                                                                : isCurrent
                                                    ...
                                                    {isCurrent && (
                                                        <p className={`${isDarkMode ? 'text-cyan-300' : 'text-cyan-600'} mb-4`}>
                    ...
                    <div className="mt-16 text-center">
                        <div className={`${isDarkMode ? 'glass-effect' : 'glass-effect-light'} rounded-3xl p-12 relative overflow-hidden`}>
                            <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/20 to-teal-600/20"></div>
                            <div className="relative z-10">
                                <h3 className={`text-4xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'} mb-6`}>Keep Going! 💪</h3>
                                <p className={`${isDarkMode ? 'text-emerald-200' : 'text-emerald-700'} mb-8 max-w-2xl mx-auto text-xl`}>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    ...
                                    <button
                                        ...
                                        className={`${isDarkMode ? 'glass-effect border-2 border-emerald-500 text-emerald-300 hover:text-white hover:bg-emerald-600/20' : 'bg-white border-2 border-emerald-500 text-emerald-600 hover:text-white hover:bg-emerald-600'} font-bold py-4 px-8 rounded-2xl transition-all duration-300`}
                                    >
